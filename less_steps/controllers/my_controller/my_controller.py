...
#ENABLE THIS LINE OF CODE IF YOU WANT TO OBTAIN A NEW SET OF TRAINING DATA SETS FOR THE SOM LEARNING, ELSE KEEP COMMENTED
#robot.run()
...
#ENABLE THIS LINES OF CODE IF YOU WANT TO TRAIN THE SOMS, ONCE THE SOMS ARE LEARNT, KEEP COMMENTED
####train SOMS
# generateAnglesSOM()
# generateVisualSOM()
...
#ENABLE THIS LINES OF CODE IF YOU WANT TO TRAIN THE HEBBIAN TABLE, ONCE THE HEBBIAN TABLE IS LEARNT, KEEP COMMENTED
#####train hebbian table
...
#UNCOMMENT THIS LINE TO BEGIN EXPERIMENT
#exp.run_exp()
